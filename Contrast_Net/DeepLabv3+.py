...
''' 
-> ResNet BackBone
https://blog.csdn.net/oYeZhou/article/details/112270908?ops_request_misc=%257B%2522request%255Fid%2522%253A%2522168592739616800215036303%2522%252C%2522scm%2522%253A%252220140713.130102334..%2522%257D&request_id=168592739616800215036303&biz_id=0&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduend~default-2-112270908-null-null.142^v88^control,239^v2^insert_chatgpt&utm_term=deeplabv3%E4%BB%A3%E7%A0%81&spm=1018.2226.3001.4187
'''
import logging
import torch.nn as nn
import numpy as np
...
class Xception(nn.Module):
    ...
    def _load_pretrained_model(self):
        ...
        pretrained_weights = torch.load(r'E:\HKK\xception-b5690688.pth')
...
class DeepLabv3p(BaseModel):
    def __init__(self, num_classes=1, in_channels=3, backbone='resnet', pretrained=True,
...
if __name__ == '__main__':
    ...
    model = DeepLabv3p(1, backbone='resnet')  # 54.700  83.02
